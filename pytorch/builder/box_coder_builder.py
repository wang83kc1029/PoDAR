...
from second.pytorch.core.box_coders import (PolarBox3dCoderTorch, BevBoxCoderTorch,
...
def build(box_coder_config):
    ...
    elif box_coder_type == 'polar_box3d_coder':
        cfg = box_coder_config.polar_box3d_coder
        return PolarBox3dCoderTorch(cfg.linear_dim, cfg.encode_angle_vector)
