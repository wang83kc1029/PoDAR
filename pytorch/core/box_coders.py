...
from second.core.box_coders import PolarBox3dCoder, GroundBox3dCoder, BevBoxCoder
from second.pytorch.core import box_torch_ops
import torch

class PolarBox3dCoderTorch(PolarBox3dCoder):
    def encode_torch(self, boxes, anchors):
        return box_torch_ops.polar_box_encode(boxes, anchors, self.vec_encode, self.linear_dim)

    def decode_torch(self, boxes, anchors):
        return box_torch_ops.polar_box_decode(boxes, anchors, self.vec_encode, self.linear_dim)
