...
class AnchorGeneratorStride_rp:
    def __init__(self,
                 sizes=[1.6, 3.9, 1.56],
                 anchor_strides=[0.4, 0.0245436926, 0.0],
                 anchor_offsets=[0.2,-0.7608544708, -1.78],
                 rotations=[0, np.pi / 2],
                 class_id=None,
                 match_threshold=-1,
                 unmatch_threshold=-1,
