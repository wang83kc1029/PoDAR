...
class PolarBox3dCoder(BoxCoder):
    ...
    def _encode(self, boxes, anchors):
        return box_np_ops.polar_box_encode(boxes, anchors, self.vec_encode, self.linear_dim)

    def _decode(self, encodings, anchors):
        return box_np_ops.polar_box_decode(encodings, anchors, self.vec_encode, self.linear_dim)
